      ...
      <Col xxl>
        <Stack className={styles.footerItems} gap={2}>
          ...
          <Button variant='footer' onClick={handleShow}>
            <FontAwesomeIcon icon={faFileLines} />&ensp;User Policy
          </Button>
          <Button variant='footer' onClick={handleShow}>
            <FontAwesomeIcon icon={faScrewdriverWrench} />&ensp;APIs
          </Button>
          <Link to="/" className={styles.logo}>
            <FontAwesomeIcon icon={faHive} />&ensp;FlexyCook
          </Link>
          <Button variant='footer' onClick={handleShow}>
            <FontAwesomeIcon icon={faEnvelope} />&ensp;Contact
          </Button>
          <Button variant='footer' onClick={handleShow}>
            <FontAwesomeIcon icon={faCircleQuestion} />&ensp;Help
          </Button>
        </Stack>
      </Col>
